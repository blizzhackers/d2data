...
new Vue({
	...
	data: {
		...
		columns: [
			...
			{ label: '1h DPS', key: 'dps', render: item => item.dps || '??', sortDefault: 0, defaultSortOrder: -1 },
			{ label: '2h DPS', key: '2handdps', render: item => item['2handdps'] || '??', sortDefault: 0, defaultSortOrder: -1 },
			{ label: 'Rng DPS', key: 'misdps', render: item => item.misdps || '??', sortDefault: 0, defaultSortOrder: -1 },
